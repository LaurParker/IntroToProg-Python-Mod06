...
# <Lauren Parker>,<11/21/20>,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def add_data_to_list(task, priority, list_of_rows):
        """adds a task and priority level to the to-do list
        ...
        dic_row = {"Task": strTask, "Priority": strPriority}
    ...
    def remove_data_from_list(task, list_of_rows):
        ...
        :param task: (string) task that will be deleted
...
class IO:
    ...
    def input_new_task_and_priority():
        """Adds task and priority to a list
    ...
    def input_task_to_remove():
        """Asks for a task that will be deleted from the list

        :return: (string) task that user would like to delete
        """
...
while(True):
    ...
    if strChoice.strip() == '1':  # Add a new Task
        ...
        d_task = IO.input_task_to_remove()
        Processor.remove_data_from_list(d_task,lstTable)
        IO.input_press_to_continue(strStatus)
        continue  # to show the menu
